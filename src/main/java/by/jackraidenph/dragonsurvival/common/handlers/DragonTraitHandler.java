...
public class DragonTraitHandler
{
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent playerTickEvent)
    {
        ...
        DragonStateProvider.getCap(playerEntity).filter(DragonStateHandler::isDragon).ifPresent(dragonStateHandler ->
        {
                    ...
                    && DSBlockTags.SPEED_UP_BLOCKS.get(dragonStateHandler.getType()).contains(block))
            {
                ...
                int maxLevel =
                        dragonStateHandler.getType() == DragonType.SEA && dragonStateHandler.getMagic().getAbility(DragonAbilities.SEA_ATHLETICS) != null ? dragonStateHandler.getMagic().getAbility(DragonAbilities.SEA_ATHLETICS).getMaxLevel() :
                                dragonStateHandler.getType() == DragonType.FOREST && dragonStateHandler.getMagic().getAbility(DragonAbilities.FOREST_ATHLETICS) != null ? dragonStateHandler.getMagic().getAbility(DragonAbilities.FOREST_ATHLETICS).getMaxLevel() :
                                        dragonStateHandler.getType() == DragonType.CAVE && dragonStateHandler.getMagic().getAbility(DragonAbilities.CAVE_ATHLETICS) != null ? dragonStateHandler.getMagic().getAbility(DragonAbilities.CAVE_ATHLETICS).getMaxLevel() :
                                                0;
                if (duration > 0)
                {
